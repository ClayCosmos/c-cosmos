-- Rollback: 002_trading

-- Remove columns from existing tables
ALTER TABLE stores DROP COLUMN IF EXISTS wallet_address;
ALTER TABLE agents DROP COLUMN IF EXISTS trading_stats;
